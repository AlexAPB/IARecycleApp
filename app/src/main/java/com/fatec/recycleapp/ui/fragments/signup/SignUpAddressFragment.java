...
import com.fatec.recycleapp.ui.activities.SignUpActivity;

/**
 * A simple {@link Fragment} subclass.
 * Use the {@link SignUpAddressFragment#newInstance} factory method to
...
public class SignUpAddressFragment extends Fragment {
    ...
    public void nextFragment(View view) {
        ((SignUpActivity) getActivity()).getPager().setCurrentItem(1, true);
    }
